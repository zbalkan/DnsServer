...
#pragma warning disable CA1416 // Validate platform compatibility
    ...
    public sealed class DnsServer : IAsyncDisposable, IDisposable, IDnsClient
    {
        ...
        bool _dnsCookiesEnabled;
        string _dnsCookiesSecretFile = "dns.cookies.state";
        int _dnsCookiesRotationPeriodHours = 24;
        bool _dnsCookiesSetTcOnBadCookie = true;
        bool _dnsCookiesAlwaysEcho = false;
        ...
        private void ReadConfigFrom(Stream s, bool isConfigTransfer)
        {
            ...
            // DNS cookies - read if available (for backwards compatibility)
            try
            {
                _dnsCookiesEnabled = bR.ReadBoolean();
                _dnsCookiesSecretFile = bR.ReadString();
                _dnsCookiesRotationPeriodHours = bR.ReadInt32();
                _dnsCookiesSetTcOnBadCookie = bR.ReadBoolean();
                _dnsCookiesAlwaysEcho = bR.ReadBoolean();
            }
            catch
            {
                // Older config file without DNS cookies settings
                _dnsCookiesEnabled = false;
                _dnsCookiesSecretFile = "dns.cookies.state";
                _dnsCookiesRotationPeriodHours = 24;
                _dnsCookiesSetTcOnBadCookie = true;
                _dnsCookiesAlwaysEcho = false;
            }
