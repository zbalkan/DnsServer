...
namespace DnsServerCore.Dns.Security
{
    public class DnsCookieValidator
    {
        ...
        private byte[] ComputeServerCookie(IPAddress clientAddress, byte[] clientCookie, byte[] secret)
        {
        ...
        private bool ValidateServerCookieWithSecret(IPAddress clientAddress, byte[] clientCookie, byte[] serverCookie, byte[] secret)
        {
            ...
            uint cookieTimestamp = BitConverter.ToUInt32(serverCookie, 2);
        ...
        {
            if (cookie == null || cookie.ClientCookie == null || cookie.ServerCookie == null)
                return false;
        ...
        {
            if (requestCookie == null || requestCookie.ClientCookie == null)
            ...
            return new EDnsCookieOptionData(requestCookie.ClientCookie, serverCookie);
        }
