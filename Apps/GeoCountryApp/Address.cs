...
namespace GeoCountry
{
    public sealed class Address : IDnsApplication, IDnsAppRecordRequestHandler
    {
        ...
        { get { return "Returns A or AAAA records based on the country or Autonomous System Number (ASN) the client queries from using MaxMind GeoIP2 Country database. Use the two-character ISO 3166-1 alpha code for the country or ASN like 'AS1234'. Note that ASN will be matched before the country code."; } }
